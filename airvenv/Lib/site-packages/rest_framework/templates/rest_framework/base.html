      ...
      {% block navbar %}
        <div class="navbar navbar-static-top {% block bootstrap_navbar_variant %}navbar-inverse{% endblock %}"
          ...
          <div class="container">
            <span>
              {% block branding %}
                <a class='navbar-brand' rel="nofollow" href='http://127.0.0.1:8000/main'>
                    Airstatus
                </a>
              {% endblock %}
            </span>
      ...
      <div class="container">
        ...
        <div id="content" role="main" aria-label="{% trans "content" %}">
          ...
          {% if delete_form %}
            ...
            <!-- Delete Modal -->
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hiddden="true">
